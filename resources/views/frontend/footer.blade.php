                    ...
                    <div class="footer-bottom_nav">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="payment">
                                    <a href="#">
                                        <img src="{{url('public/front-end/images/footer/payment/1.png')}}" alt="Hiraola's Payment Method">
                                    </a>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                ...
                                <div class="sp-img_area">
                                    <div class="sp-img_slider-2 slick-img-slider hiraola-slick-slider arrow-type-two" data-slick-options='{
                                        ...
                                        <div class="single-slide red">
                                            <img src="{{url('public/front-end/images/single-product/large-size/1.jpg')}}" alt="Hiraola's Product Image">
                                        </div>
                                        <div class="single-slide orange">
                                            <img src="{{url('public/front-end/images/single-product/large-size/2.jpg')}}" alt="Hiraola's Product Image">
                                        </div>
                                        <div class="single-slide brown">
                                            <img src="{{url('public/front-end/images/single-product/large-size/3.jpg')}}" alt="Hiraola's Product Image">
                                        </div>
                                        <div class="single-slide umber">
                                            <img src="{{url('public/front-end/images/single-product/large-size/4.jpg')}}" alt="Hiraola's Product Image">
                                        </div>
                                    </div>
                                   ...
                                   "focusOnSelect": true
                                        ...
                                        <div class="single-slide red">
                                            <img src="{{url('public/front-end/images/single-product/small-size/1.jpg')}}" alt="Hiraola's Product Thumnail">
                                        </div>
                                        <div class="single-slide orange">
                                            <img src="{{url('public/front-end/images/single-product/small-size/2.jpg')}}" alt="Hiraola's Product Thumnail">
                                        </div>
                                        <div class="single-slide brown">
                                            <img src="{{url('public/front-end/images/single-product/small-size/3.jpg')}}" alt="Hiraola's Product Thumnail">
                                        </div>
                                        <div class="single-slide umber">
                                            <img src="{{url('public/front-end/images/single-product/small-size/4.jpg')}}" alt="Hiraola's Product Thumnail">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
============================================ -->
    ...
    <!-- jQuery JS -->
    <script src="{{url('public/front-end/js/vendor/jquery-1.12.4.min.js')}}"></script>
    <!-- Modernizer JS -->
    <script src="{{url('public/front-end/js/vendor/modernizr-2.8.3.min.js')}}"></script>
    <!-- Popper JS -->
    <script src="{{url('public/front-end/js/vendor/popper.min.js')}}"></script>
    <!-- Bootstrap JS -->
    <script src="{{url('public/front-end/js/vendor/bootstrap.min.js')}}"></script>

    <!-- Slick Slider JS -->
    <script src="{{url('public/front-end/js/plugins/slick.min.js')}}"></script>
    <!-- Countdown JS -->
    <script src="{{url('public/front-end/js/plugins/countdown.js')}}"></script>
    <!-- Barrating JS -->
    <script src="{{url('public/front-end/js/plugins/jquery.barrating.min.js')}}"></script>
    <!-- Counterup JS -->
    <script src="{{url('public/front-end/js/plugins/jquery.counterup.js')}}"></script>
    <!-- Nice Select JS -->
    <script src="{{url('public/front-end/js/plugins/jquery.nice-select.js')}}"></script>
    <!-- Sticky Sidebar JS -->
    <script src="{{url('public/front-end/js/plugins/jquery.sticky-sidebar.js')}}"></script>
    <!-- Jquery-ui JS -->
    <script src="{{url('public/front-end/js/plugins/jquery-ui.min.js')}}"></script>
    <script src="{{url('public/front-end/js/plugins/jquery.ui.touch-punch.min.js')}}"></script>
    <!-- Lightgallery JS -->
    <script src="{{url('public/front-end/js/plugins/lightgallery.min.js')}}"></script>
    <!-- Scroll Top JS -->
    <script src="{{url('public/front-end/js/plugins/scroll-top.js')}}"></script>
    <!-- Theia Sticky Sidebar JS -->
    <script src="{{url('public/front-end/js/plugins/theia-sticky-sidebar.min.js')}}"></script>
    <!-- Waypoints JS -->
    <script src="{{url('public/front-end/js/plugins/waypoints.min.js')}}"></script>
    <!-- Instafeed JS -->
