                                ...
                                <div class="single_product">
                                    <div class="product-img">
                                        <a href="single-product.html">
                                            <img class="primary-img" src="{{url('public/front-end/images/product/medium-size/1-1.jpg')}}" alt="Hiraola's Product Image">
                                ...
                                <div class="single_product">
                                    <div class="product-img">
                                        <a href="single-product.html">
                                            ...
                                            <img class="secondary-img" src="{{url('public/front-end/images/product/medium-size/1-1.jpg')}}" alt="Hiraola's Product Image">
                                        </a>
                                        <span class="sticker-2">Sale</span>
                                        <div class="add-actions">
                                            <ul>
                                ...
                                <div class="hiraola-product-tab_slider-2">
                                    ...
                                    <div class="slide-item">
                                        <div class="single_product">
                                            <div class="product-img">
                                                <a href="single-product.html">
                                                    <img class="primary-img" src="{{url('public/front-end/assets/images/product/medium-size/1-8.jpg')}}" alt="Hiraola's Product Image">
                                                    <img class="secondary-img" src="{{url('public/front-end/images/product/medium-size/1-5.jpg')}}" alt="Hiraola's Product Image">
                                                </a>
                                                <span class="sticker">New</span>
                                                <div class="add-actions">
